...
<title>${message("admin.plugin.alipayEscowPayment.setting")} - Powered By SHOPEC</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/shopec/" target="_blank">[${message("admin.plugin.alipayEscowPayment.register")}]</a>
