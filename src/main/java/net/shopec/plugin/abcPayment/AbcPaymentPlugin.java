//package net.shopec.plugin.abcPayment;
//
...
//			inputStream = new BufferedInputStream(ResourceUtils.getURL(CERTIFICATE_FILE_PATH).openStream());
...
//		trxRequest.addElement("MerchantRemarks").setText("shopec");
