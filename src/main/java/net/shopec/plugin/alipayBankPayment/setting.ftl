...
<title>${message("admin.plugin.alipayBankPayment.setting")} - Powered By SHOPEC</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/shopec/" target="_blank">[${message("admin.plugin.alipayBankPayment.register")}]</a>
