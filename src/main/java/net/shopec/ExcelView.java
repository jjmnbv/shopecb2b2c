...
public class ExcelView extends AbstractView {
	...
	static {
		...
		try {
			properties = PropertiesLoaderUtils.loadProperties(new ClassPathResource(CommonAttributes.SHOPEC_PROPERTIES_PATH));
		} catch (IOException e) {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			inputStream = new BufferedInputStream(ResourceUtils.getURL(TEMPLATE_LOADER_PATH + templatePath).openStream());
