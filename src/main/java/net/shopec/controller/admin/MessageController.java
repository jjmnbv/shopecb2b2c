...
public class MessageController extends BaseController {
	...
	public String send(Long draftMessageId, String username, String title, String content, @RequestParam(defaultValue = "false") Boolean isDraft, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		if (isDraft) {
			addFlashMessage(redirectAttributes, net.shopec.Message.success("admin.message.saveDraftSuccess"));
			return "redirect:draft";
		} else {
			addFlashMessage(redirectAttributes, net.shopec.Message.success("admin.message.sendSuccess"));
	...
	public String reply(Long id, String content, HttpServletRequest request, RedirectAttributes redirectAttributes) {
		...
		if ((forMessage.getReceiver() == null && !forMessage.getSenderDelete()) || (forMessage.getSender() == null && !forMessage.getReceiverDelete())) {
			...
			addFlashMessage(redirectAttributes, net.shopec.Message.success("admin.message.replySuccess"));
			return "redirect:list";
		}
	}
	...
	public String list(Pageable pageable, Model model) {
		model.addAttribute("page", messageService.findPage(new Member(), pageable));
	 ...
	 */
	@PostMapping("delete")
	public @ResponseBody net.shopec.Message delete(Long[] ids) {
		if (ids != null) {
			for (Long id : ids) {
