...
public class StoreProductCategoryServiceImpl extends BaseServiceImpl<StoreProductCategory> implements StoreProductCategoryService {
	...
	public Page<StoreProductCategory> findPage(Store store, Pageable pageable) {
		com.baomidou.mybatisplus.plugins.Page<StoreProductCategory> plusPage = getPlusPage(pageable);
		plusPage.setRecords(storeProductCategoryDao.findPage(plusPage, getWrapper(pageable), store));
	...
	public StoreProductCategory save(StoreProductCategory storeProductCategory) {
		Assert.notNull(storeProductCategory, "notNull");
