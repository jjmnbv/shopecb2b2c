...
<title>${message("member.couponCode.list")}[#if showPowered] - Powered By SHOPEC[/#if]</title>
							...
							<tr[#if !couponCode_has_next] class="last"[/#if]>
								...
								<td>
									[#if couponCode.usedDate??]
										<span title="${couponCode.usedDate?string("yyyy-MM-dd HH:mm:ss")}">${couponCode.usedDate?string("yyyy-MM-dd HH:mm:ss")}</span>
									[#else]
										-
									[/#if]
								</td>
								<td>
									[#if couponCode.coupon.endDate??]
										<span title="${couponCode.coupon.endDate?string("yyyy-MM-dd HH:mm:ss")}">${couponCode.coupon.endDate?string("yyyy-MM-dd HH:mm:ss")}</span>
									[#else]
										-
									[/#if]
								</td>
