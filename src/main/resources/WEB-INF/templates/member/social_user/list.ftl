...
<title>${message("member.socialUser.list")}[#if showPowered] - Powered By SHOPEC[/#if]</title>
					...
					<table id="listTable" class="list">
						...
						[#list page.content as socialUser]
							<tr[#if !socialUser_has_next] class="last"[/#if]>
								...
								<td>
									<span title="${socialUser.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${socialUser.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
								</td>
								<td>
