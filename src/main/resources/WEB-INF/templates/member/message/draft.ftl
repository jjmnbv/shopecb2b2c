...
<title>${message("member.message.draft")}[#if showPowered] - Powered By SHOPEC[/#if]</title>
					...
					<table id="listTable" class="list">
						...
						[#list page.content as memberMessage]
							<tr[#if !memberMessage_has_next] class="last"[/#if]>
								...
								<td>
									<span title="${memberMessage.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${memberMessage.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
								</td>
								<td>
