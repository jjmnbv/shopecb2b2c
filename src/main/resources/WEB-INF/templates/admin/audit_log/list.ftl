...
<title>${message("admin.auditLog.list")} - Powered By SHOPEC</title>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as auditLog]
				<tr>
					...
					<td>
						<span title="${auditLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${auditLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
					<td>
