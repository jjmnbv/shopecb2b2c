...
<title>${message("admin.orderReturns.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.orderReturns.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as returns]
				<tr>
					...
					<td>
						<span title="${returns.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${returns.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
					<td>
