...
<title>${message("admin.storagePlugin.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.storagePlugin.list")} <span>(${message("admin.page.total", storagePlugins?size)})</span>
	</div>
