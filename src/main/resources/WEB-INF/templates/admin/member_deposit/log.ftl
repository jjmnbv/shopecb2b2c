...
<title>${message("admin.memberDeposit.log")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.memberDeposit.log")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as memberDepositLog]
				<tr>
					...
					<td>
						<span title="${memberDepositLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${memberDepositLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
				</tr>
			[/#list]
		</table>
