...
<title>${message("admin.stock.log")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.stock.log")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as stockLog]
				<tr>
					...
					<td>
						<span title="${stockLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${stockLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
				</tr>
			[/#list]
		</table>
