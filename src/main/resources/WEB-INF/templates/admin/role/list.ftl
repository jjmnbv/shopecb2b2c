...
<title>${message("admin.role.list")} - Powered By SHOPEC</title>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as role]
				<tr>
					...
					<td>
						<span title="${role.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${role.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
					<td>
