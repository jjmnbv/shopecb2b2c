...
<title>${message("admin.product.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.product.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list" method="get">
		...
		<div class="bar">
			...
			<div id="searchPropertyMenu" class="dropdownMenu">
				...
				<ul>
					<li[#if page.searchProperty == "sn"] class="current"[/#if] val="product.sn">${message("Product.sn")}</li>
					<li[#if page.searchProperty == "name"] class="current"[/#if] val="product.name">${message("Product.name")}</li>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as product]
				<tr>
					...
					<td>
						<span title="${product.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${product.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
					<td>
