...
<title>${message("admin.friendLink.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.friendLink.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as friendLink]
				<tr>
					...
					<td>
						<span title="${friendLink.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${friendLink.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
					<td>
