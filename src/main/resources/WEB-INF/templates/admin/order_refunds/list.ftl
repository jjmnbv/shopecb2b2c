...
<title>${message("admin.orderRefunds.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.orderRefunds.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as refunds]
				<tr>
					...
					<td>
						<span title="${refunds.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${refunds.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
					<td>
