...
<title>${message("admin.paymentPlugin.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.paymentPlugin.list")} <span>(${message("admin.page.total", paymentPlugins?size)})</span>
	</div>
