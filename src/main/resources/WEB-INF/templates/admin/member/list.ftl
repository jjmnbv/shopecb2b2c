...
<title>${message("admin.member.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.member.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as member]
				<tr>
					...
					<td>
						<span title="${member.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${member.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
					<td>
						[#if !member.isEnabled]
