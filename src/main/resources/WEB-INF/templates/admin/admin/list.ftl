...
<title>${message("admin.admin.list")} - Powered By SHOPEC</title>
				...
				<tr>
					...
					<td>
						[#if admin.lastLoginDate??]
							<span title="${admin.lastLoginDate?string("yyyy-MM-dd HH:mm:ss")}">${admin.lastLoginDate?string("yyyy-MM-dd HH:mm:ss")}</span>
						[#else]
							-
						[/#if]
					</td>
					...
					<td>
						<span title="${admin.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${admin.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
					<td>
