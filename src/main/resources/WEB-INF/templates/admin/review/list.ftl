...
<title>${message("admin.review.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.review.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
