...
<title>${message("admin.articleCategory.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.articleCategory.list")}
	</div>
	<div class="bar">
