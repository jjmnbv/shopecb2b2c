...
<title>${message("admin.order.list")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.order.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="member_id">${message("Order.member")}</a>
				</th>
				<th>
                    <span>${message("Order.store")}</span>
				</th>
				<th>
			...
			[#list page.content as order]
				<tr>
					...
					<td>
						<span title="${order.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${order.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
					[@shiro.hasPermission name = "admin:print"]
						<td>
							<select name="print">
