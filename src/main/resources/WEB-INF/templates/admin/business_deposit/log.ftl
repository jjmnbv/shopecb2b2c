...
<title>${message("admin.businessDeposit.log")} - Powered By SHOPEC</title>
...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/main/list">${message("admin.breadcrumb.home")}</a> &raquo; ${message("admin.businessDeposit.log")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as businessDepositLog]
				<tr>
					...
					<td>
						<span title="${businessDepositLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${businessDepositLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
					</td>
				</tr>
			[/#list]
		</table>
