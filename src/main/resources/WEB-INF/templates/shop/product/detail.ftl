...
[@seo type = "productDetail"]
	<title>${seo.resolveTitle()}[#if showPowered] - Powered By SHOPEC[/#if]</title>
											...
											[#list reviews as review]
													<tr>
														...
														<td>
															...
															[/#if]
															<span title="${review.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${review.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
														</td>
													</tr>
										...
										[#list consultations as consultation]
											<li>
												...
												<span>
													...
													[/#if]
													<span title="${consultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${consultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
												</span>
													...
													<ul>
														[#list consultation.replyConsultations as replyConsultation]
															<li>
																...
																<span title="${replyConsultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${replyConsultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
															</li>
														[/#list]
													</ul>
												[/#if]
