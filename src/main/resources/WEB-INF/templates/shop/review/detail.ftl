...
<title>${product.name} ${message("shop.review.title")}[#if showPowered] - Powered By SHOPEC[/#if]</title>
								...
								[#list page.content as review]
									<tr[#if !review_has_next] class="last"[/#if]>
										...
										<td>
											...
											[/#if]
											<div><span title="${review.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${review.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span></div>
										</td>
										[#if review.replyReviews?has_content]
											...
											[#list review.replyReviews as replyReview]
												<tr>
													...
													<td>
														<span title="${replyReview.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${replyReview.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
													</td>
												</tr>
											[/#list]
										[/#if]
