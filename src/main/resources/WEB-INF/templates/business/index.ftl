...
<head>
	...
	<title>${message("business.index.title")} - Powered By SHOPEC</title>
								...
								<div class="row">
									...
									<div class="col-xs-6">
										...
										<p>
											...
											<span class="orange">${(currentStore.endDate?string("yyyy-MM-dd HH:mm:ss"))!message("business.index.infinite")}</span>
										</p>
									</div>
								</div>
							</div>
