...
<head>
	...
	<title>${message("business.coupon.list")} - Powered By SHOPEC</title>
												...
												<div class="box-tools">
													<div id="search" class="input-group">
														<div class="input-group-btn">
															...
															<ul class="dropdown-menu">
																<li[#if !page.searchProperty?? || page.searchProperty == "name"] class="active"[/#if] data-search-property="coupon.name">
