...
<head>
	...
	<title>${message("business.review.reply")} - Powered By SHOPEC</title>
										...
										[#if review.replyReviews?has_content]
											[#list review.replyReviews as replyReview]
												<div class="form-group">
													...
													<div class="col-xs-1">
														<p class="form-control-static" title="${replyReview.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${replyReview.createdDate?string("yyyy-MM-dd HH:mm:ss")}</p>
													</div>
												</div>
											[/#list]
										[/#if]
