...
<head>
	...
	<title>${message("business.order.view")} - Powered By SHOPEC</title>
													...
													<tbody>
														[#list order.orderPayments as orderPayment]
															<tr>
																...
																<td>
																	<span title="${orderPayment.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${orderPayment.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
																</td>
															</tr>
														[/#list]
													</tbody>
													...
													<tbody>
														[#list order.orderShippings as orderShipping]
															<tr>
																...
																<td>
																	<span title="${orderShipping.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${orderShipping.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
																</td>
															</tr>
														[/#list]
													</tbody>
													...
													<tbody>
														[#list order.orderReturns as orderReturns]
															<tr>
																...
																<td>
																	<span title="${orderReturns.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${orderReturns.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
																</td>
															</tr>
														[/#list]
													</tbody>
													...
													<tbody>
														[#list order.orderLogs as orderLog]
															<tr>
																...
																<td>
																	<span title="${orderLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${orderLog.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
																</td>
															</tr>
														[/#list]
													</tbody>
