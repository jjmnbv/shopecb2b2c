...
<head>
	...
	<title>${message("business.productNotify.list")} - Powered By SHOPEC</title>
											...
											<tbody>
												[#list page.content as productNotify]
													<tr>
														...
														<td>
															<span title="${productNotify.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${productNotify.createdDate?string("yyyy-MM-dd HH:mm:ss")}</span>
														</td>
														<td>
