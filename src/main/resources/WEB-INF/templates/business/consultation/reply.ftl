...
<head>
	...
	<title>${message("business.consultation.reply")} - Powered By SHOPEC</title>
										...
										[#if consultation.replyConsultations?has_content]
											[#list consultation.replyConsultations as replyConsultation]
												<div class="form-group">
													...
													<div class="col-xs-1">
														<p class="form-control-static" title="${replyConsultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}">${replyConsultation.createdDate?string("yyyy-MM-dd HH:mm:ss")}</p>
													</div>
												</div>
											[/#list]
										[/#if]
